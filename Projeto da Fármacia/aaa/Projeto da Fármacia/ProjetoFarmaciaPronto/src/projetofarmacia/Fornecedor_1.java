...
public class Fornecedor_1 implements Serializable {
    ...
    public Fornecedor_1(Integer id) {
        this.id = id;
    }

    public Fornecedor_1(Integer id, String cnpj, String email, String nome, String telefone, String endereco) {
        this.id = id;
        this.cnpj = cnpj;
        this.email = email;
        this.nome = nome;
